 ...
 * generated in the org.csapi.schema.parlayx.terminal_location.notification_manager.v2_3.local package. 
...
public class ObjectFactory {
    ...
    private final static QName _StartPeriodicNotificationResponse_QNAME = new QName("http://www.csapi.org/schema/parlayx/terminal_location/notification_manager/v2_3/local", "startPeriodicNotificationResponse");
    private final static QName _StartPeriodicNotification_QNAME = new QName("http://www.csapi.org/schema/parlayx/terminal_location/notification_manager/v2_3/local", "startPeriodicNotification");
    private final static QName _EndNotification_QNAME = new QName("http://www.csapi.org/schema/parlayx/terminal_location/notification_manager/v2_3/local", "endNotification");
    private final static QName _EndNotificationResponse_QNAME = new QName("http://www.csapi.org/schema/parlayx/terminal_location/notification_manager/v2_3/local", "endNotificationResponse");
    private final static QName _StartGeographicalNotificationResponse_QNAME = new QName("http://www.csapi.org/schema/parlayx/terminal_location/notification_manager/v2_3/local", "startGeographicalNotificationResponse");
    private final static QName _StartGeographicalNotification_QNAME = new QName("http://www.csapi.org/schema/parlayx/terminal_location/notification_manager/v2_3/local", "startGeographicalNotification");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.csapi.schema.parlayx.terminal_location.notification_manager.v2_3.local
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/terminal_location/notification_manager/v2_3/local", name = "startPeriodicNotificationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/terminal_location/notification_manager/v2_3/local", name = "startPeriodicNotification")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/terminal_location/notification_manager/v2_3/local", name = "endNotification")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/terminal_location/notification_manager/v2_3/local", name = "endNotificationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/terminal_location/notification_manager/v2_3/local", name = "startGeographicalNotificationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/terminal_location/notification_manager/v2_3/local", name = "startGeographicalNotification")
