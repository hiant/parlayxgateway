 ...
 * generated in the org.csapi.schema.parlayx.terminal_location.v3_1.local package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetTerminalDistance_QNAME = new QName("http://www.csapi.org/schema/parlayx/terminal_location/v3_1/local", "getTerminalDistance");
    private final static QName _GetLocationForGroupResponse_QNAME = new QName("http://www.csapi.org/schema/parlayx/terminal_location/v3_1/local", "getLocationForGroupResponse");
    private final static QName _GetTerminalDistanceResponse_QNAME = new QName("http://www.csapi.org/schema/parlayx/terminal_location/v3_1/local", "getTerminalDistanceResponse");
    private final static QName _GetLocationResponse_QNAME = new QName("http://www.csapi.org/schema/parlayx/terminal_location/v3_1/local", "getLocationResponse");
    private final static QName _GetLocation_QNAME = new QName("http://www.csapi.org/schema/parlayx/terminal_location/v3_1/local", "getLocation");
    private final static QName _GetLocationForGroup_QNAME = new QName("http://www.csapi.org/schema/parlayx/terminal_location/v3_1/local", "getLocationForGroup");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.csapi.schema.parlayx.terminal_location.v3_1.local
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/terminal_location/v3_1/local", name = "getTerminalDistance")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/terminal_location/v3_1/local", name = "getLocationForGroupResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/terminal_location/v3_1/local", name = "getTerminalDistanceResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/terminal_location/v3_1/local", name = "getLocationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/terminal_location/v3_1/local", name = "getLocation")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/terminal_location/v3_1/local", name = "getLocationForGroup")
